      ...
      <div className="rounded-2xl bg-white p-5 ring-1 ring-slate-200/80 sm:p-6">
        <div className="flex items-start gap-4 sm:items-center">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            <button
              type="button"
              onClick={() => { setEditName(user.name); setEditEmail(user.email); setEditLocation(user.location); setEditImageFile(null); setEditImagePreview(null); setShowEditProfile(true) }}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="group relative h-20 w-20 overflow-hidden rounded-full bg-slate-100"
                >
                  <ImageWithFallback
                    src={user.image ?? ""}
                    alt={user.name}
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  if (result.success) {
                    ...
                    setUser((prev) => prev ? { ...prev, name: editName, email: editEmail, location: editLocation, image: editImagePreview ?? prev.image } : prev)
