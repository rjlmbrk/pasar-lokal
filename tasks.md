...
| **Fase 6** | Sistem Komunikasi & Dasbor (`chat`, `profile`) | Jendela obrolan real-time (COD) dan manajemen barang terjual. | ✅ Selesai |
...
* [x] **6.1. Halaman Sistem Obrolan (`src/app/chat/`)**
...
* [x] **6.2. Dasbor Profil Pengguna (`src/app/profile/`)**
